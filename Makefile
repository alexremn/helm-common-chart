...
NEGATIVE_VARIANTS := security-invalid affinity-scalar hpa-badkind extrapodconfig-containers hpa-no-maxreplicas deploytool-invalid argocd-lookup config-define-badtype
