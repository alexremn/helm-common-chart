...
SMOKE_VARIANTS := generic werf-legacy image-resolution features profile-generic profile-rails profile-python profile-go \
                  ...
                  monitor-release \
                  prometheusrule toplevel-passthrough priorityclass triggerauth automount \
                  ...
                  schema-global \
                  hyphen-component \
                  intorpercent safename labelctx label-override affinity-legacy affinity-legacy-no-env affinity-map podannotations daemonset-flat \
                  lowercase-aliases \
                  sidecars \
...
NEGATIVE_VARIANTS := security-invalid affinity-scalar hpa-badkind extrapodconfig-containers hpa-no-maxreplicas deploytool-invalid argocd-lookup config-define-badtype configmap-nil-value dbpool-missing-input dbpool-bad-cpu
